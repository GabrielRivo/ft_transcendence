...
export function CreateGroupModal({ onClose }: CreateGroupModalProps) {
	...
	return createPortal(
		...
		>
			<div className="w-full max-w-md rounded-xl border border-purple-500/30 bg-slate-900 p-6 shadow-2xl shadow-purple-500/10">
				{/* Header */}
					...
					<form onSubmit={handleSubmit}>
						<div className="mb-6">
							...
							<input
								...
								maxLength={50}
								className="w-full rounded-lg border border-white/10 bg-slate-800 px-4 py-3 text-white placeholder-gray-500 outline-none transition-colors focus:border-purple-500"
								autoFocus
							/>
						...
						<div className="flex gap-3">
							...
							<button
								...
								className="flex-1 rounded-lg bg-gradient-to-r from-purple-500 to-purple-600 py-3 text-sm font-medium text-white transition-all hover:from-purple-400 hover:to-purple-500 disabled:cursor-not-allowed disabled:opacity-50"
							>
