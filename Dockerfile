...
COPY apps/worker-mail/package.json ./apps/worker-mail/
...
COPY apps/worker-mail ./apps/worker-mail
...
RUN pnpm --filter worker-mail run build

# Exposition du port
EXPOSE 3000

# Démarrage de l'application
CMD ["node", "apps/worker-mail/dist/src/index.js"]